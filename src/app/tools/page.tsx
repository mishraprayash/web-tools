...
import { 
  ...
  Link2, CalendarClock, FileText, Palette, KeyRound,
...
const tools = [
  ...
  { id: 'text', name: 'Text Case Converter', description: 'camelCase, snake_case, Title Case & more', icon: FileText, color: 'from-pink-500 to-rose-500', category: 'Text' },
...
const categories = [
  ...
  { name: 'Text', tools: ['regex', 'uuid', 'text', 'lorem-ipsum'] },
